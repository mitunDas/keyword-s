...
<div class="container">
            <form class="wrap" name="form">
               <div class="display">
<textarea name="textarea" cols="30"rows="10"></textarea></div>
...
<input type="button" value="q" name="q" onclick="disp(q.value)">
   ...
   <input type="button" class="heart" value="♥️" name="♥️"></div>
<div class="fff">
    <input type="button" id="space" value="space">
              ...
              <audio controls loop style="display:none;" id="music">
 <source src="https://dl.dropbox.com/s/9i0w2g1ocwpoghq/videoplayback%20%288%29.mp4?dl=0">
...
function disp(resulty){
    
    form.textarea.value=form.textarea.value + resulty;
    spaceBtn.onclick = (()=>{
        form.textarea.value += " ";
